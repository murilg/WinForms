namespace WinFormsApp5
{
    partial class Form5
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox2.Items.AddRange(new object[] { "По всем полям", "Марка", "Модель", "Госномер", "Цвет", "Год производства", "VIN", "СТС", "Дата выдачи СТС", "Фамилия", "Имя", "Отчество", "Дата рождения", "Адрес", "Телефон" });
            ...
            comboBox1.Items.AddRange(new object[] { "Марка", "Модель", "Госномер", "Цвет", "Год производства", "VIN", "СТС", "Дата выдачи СТС", "Фамилия", "Имя", "Отчество", "Дата рождения", "Адрес", "Телефон" });
