namespace WinFormsApp5
{
    partial class Form6
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox2.Items.AddRange(new object[] { "По всем полям", "Код ДТП", "Марка", "Модель", "Госномер", "VIN", "СТС", "Фамилия владельца", "Имя владельца", "Отчество владельца", "Адрес владельца", "Фамилия водителя", "Имя водителя", "Отчество водителя", "Дата рождения водителя", "Адрес водителя", "Телефон водителя", "ВУ", "Категория", "Название страховой организации", "Серия и номер страховки", "Город", "Улица", "Дом", "Дата и время", "Кол-во раненых", "Кол-во погибших", "Оформлялось ли сотрудником ГИБДД" });
            ...
            comboBox1.Items.AddRange(new object[] { "Код ДТП", "Марка", "Модель", "Госномер", "VIN", "СТС", "Фамилия владельца", "Имя владельца", "Отчество владельца", "Адрес владельца", "Фамилия водителя", "Имя водителя", "Отчество водителя", "Дата рождения водителя", "Адрес водителя", "Телефон водителя", "ВУ", "Категория", "Название страховой организации", "Серия и номер страховки", "Город", "Улица", "Дом", "Дата и время", "Кол-во раненых", "Кол-во погибших", "Оформлялось ли сотрудником ГИБДД" });
