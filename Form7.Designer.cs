namespace WinFormsApp5
{
    partial class Form7
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox2.Items.AddRange(new object[] { "По всем полям", "Номер страховки", "Тип", "Дата начала страховки", "Название страховой компании", "Марка", "Модель", "Госномер", "VIN", "Фамилия водителя", "Имя", "Отчество", "ВУ", "Категория", "Дата выдачи ВУ" });
            ...
            comboBox1.Items.AddRange(new object[] { "Номер страховки", "Тип", "Дата начала страховки", "Название страховой компании", "Марка", "Модель", "Госномер", "VIN", "Фамилия водителя", "Имя", "Отчество", "ВУ", "Категория", "Дата выдачи ВУ" });
