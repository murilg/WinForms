namespace WinFormsApp5
{
    partial class Form8
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBox2.Items.AddRange(new object[] { "По всем полям", "Фамилия", "Имя", "Отчество", "Дата рождения", "Адрес", "Телефон" });
            ...
            comboBox1.Items.AddRange(new object[] { "Фамилия", "Имя", "Отчество", "Дата рождения", "Адрес", "Телефон" });
